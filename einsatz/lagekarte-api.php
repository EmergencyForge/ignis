<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/fire/lagekarte.
...
$selfPath = 'einsatz/lagekarte-api.php';
...
header('Location: ' . rtrim($base, '/') . '/api/fire/lagekarte' . $qs, true, 308);
exit;
