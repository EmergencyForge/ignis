<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/system/regenerate-api-key.
...
$selfPath = 'settings/system/regenerate-api-key.php';
...
header('Location: ' . rtrim($base, '/') . '/api/system/regenerate-api-key' . $qs, true, 308);
exit;
