<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/pois/departments-sort.
...
$selfPath = 'settings/pois/departments-update-sort.php';
...
header('Location: ' . rtrim($base, '/') . '/api/pois/departments-sort' . $qs, true, 308);
exit;
