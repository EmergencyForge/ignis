 ...
 *
 * Original-Datei: assets/database/insert_config_25032026_federation.php
 * Spiegelung:     database/legacy/insert_config_25032026_federation.php
 *
...
class InsertConfig25032026Federation extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/insert_config_25032026_federation.php';
    }
}
