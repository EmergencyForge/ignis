 ...
 *
 * Original-Datei: assets/database/create_intra_fire_incident_vehicles_23122025.php
 * Spiegelung:     database/legacy/create_intra_fire_incident_vehicles_23122025.php
 *
...
class CreateIntraFireIncidentVehicles23122025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_fire_incident_vehicles_23122025.php';
    }
}
