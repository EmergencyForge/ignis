 ...
 *
 * Original-Datei: assets/database/create_intra_fire_incidents_23122025.php
 * Spiegelung:     database/legacy/create_intra_fire_incidents_23122025.php
 *
...
class CreateIntraFireIncidents23122025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_fire_incidents_23122025.php';
    }
}
