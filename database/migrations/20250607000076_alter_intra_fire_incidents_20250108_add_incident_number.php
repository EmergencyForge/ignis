 ...
 *
 * Original-Datei: assets/database/alter_intra_fire_incidents_20250108_add_incident_number.php
 * Spiegelung:     database/legacy/alter_intra_fire_incidents_20250108_add_incident_number.php
 *
...
class AlterIntraFireIncidents20250108AddIncidentNumber extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_fire_incidents_20250108_add_incident_number.php';
    }
}
