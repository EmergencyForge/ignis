 ...
 *
 * Original-Datei: assets/database/create_intra_federation_cache_25032026.php
 * Spiegelung:     database/legacy/create_intra_federation_cache_25032026.php
 *
...
class CreateIntraFederationCache25032026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_federation_cache_25032026.php';
    }
}
