 ...
 *
 * Original-Datei: assets/database/create_intra_antraege_daten_30092025.php
 * Spiegelung:     database/legacy/create_intra_antraege_daten_30092025.php
 *
...
class CreateIntraAntraegeDaten30092025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_antraege_daten_30092025.php';
    }
}
