 ...
 *
 * Original-Datei: assets/database/alter_intra_users_09032026_theme.php
 * Spiegelung:     database/legacy/alter_intra_users_09032026_theme.php
 *
...
class AlterIntraUsers09032026Theme extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_users_09032026_theme.php';
    }
}
