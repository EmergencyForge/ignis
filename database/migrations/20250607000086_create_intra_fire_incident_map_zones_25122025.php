 ...
 *
 * Original-Datei: assets/database/create_intra_fire_incident_map_zones_25122025.php
 * Spiegelung:     database/legacy/create_intra_fire_incident_map_zones_25122025.php
 *
...
class CreateIntraFireIncidentMapZones25122025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_fire_incident_map_zones_25122025.php';
    }
}
