 ...
 *
 * Original-Datei: assets/database/create_intra_mitarbeiter_dienstgrade_07062025.php
 * Spiegelung:     database/legacy/create_intra_mitarbeiter_dienstgrade_07062025.php
 *
...
class CreateIntraMitarbeiterDienstgrade07062025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_mitarbeiter_dienstgrade_07062025.php';
    }
}
