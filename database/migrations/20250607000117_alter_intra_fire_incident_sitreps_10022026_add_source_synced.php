 ...
 *
 * Original-Datei: assets/database/alter_intra_fire_incident_sitreps_10022026_add_source_synced.php
 * Spiegelung:     database/legacy/alter_intra_fire_incident_sitreps_10022026_add_source_synced.php
 *
...
class AlterIntraFireIncidentSitreps10022026AddSourceSynced extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_fire_incident_sitreps_10022026_add_source_synced.php';
    }
}
