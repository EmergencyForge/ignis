 ...
 *
 * Original-Datei: assets/database/migrate_fix_sitrep_timezone_16022026.php
 * Spiegelung:     database/legacy/migrate_fix_sitrep_timezone_16022026.php
 *
...
class MigrateFixSitrepTimezone16022026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/migrate_fix_sitrep_timezone_16022026.php';
    }
}
