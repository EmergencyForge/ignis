 ...
 *
 * Original-Datei: assets/database/alter_intra_kb_entries_29112025_pinned.php
 * Spiegelung:     database/legacy/alter_intra_kb_entries_29112025_pinned.php
 *
...
class AlterIntraKbEntries29112025Pinned extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_kb_entries_29112025_pinned.php';
    }
}
