 ...
 *
 * Original-Datei: assets/database/create_intra_dashboard_categories_07062025.php
 * Spiegelung:     database/legacy/create_intra_dashboard_categories_07062025.php
 *
...
class CreateIntraDashboardCategories07062025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_dashboard_categories_07062025.php';
    }
}
