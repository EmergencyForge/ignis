 ...
 *
 * Original-Datei: assets/database/insert_intra_config_defaults_04112025.php
 * Spiegelung:     database/legacy/insert_intra_config_defaults_04112025.php
 *
...
class InsertIntraConfigDefaults04112025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/insert_intra_config_defaults_04112025.php';
    }
}
