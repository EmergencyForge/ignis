 ...
 *
 * Original-Datei: assets/database/create_intra_fahrzeuge_import_queue_30032026.php
 * Spiegelung:     database/legacy/create_intra_fahrzeuge_import_queue_30032026.php
 *
...
class CreateIntraFahrzeugeImportQueue30032026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_fahrzeuge_import_queue_30032026.php';
    }
}
