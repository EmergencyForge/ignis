 ...
 *
 * Original-Datei: assets/database/insert_intra_mitarbeiter_fwquali_07062025.php
 * Spiegelung:     database/legacy/insert_intra_mitarbeiter_fwquali_07062025.php
 *
...
class InsertIntraMitarbeiterFwquali07062025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/insert_intra_mitarbeiter_fwquali_07062025.php';
    }
}
