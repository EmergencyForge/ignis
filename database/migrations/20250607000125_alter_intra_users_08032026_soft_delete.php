 ...
 *
 * Original-Datei: assets/database/alter_intra_users_08032026_soft_delete.php
 * Spiegelung:     database/legacy/alter_intra_users_08032026_soft_delete.php
 *
...
class AlterIntraUsers08032026SoftDelete extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_users_08032026_soft_delete.php';
    }
}
