...
try {
    ...
    INSERT IGNORE INTO `intra_antrag_typen` 
        ...
        VALUES 
    ('Beförderungsantrag', 'Antrag auf Beförderung in den nächsten Rank', 'fa-solid fa-angles-up', 1, 1, NULL);
    ...
    INSERT IGNORE INTO `intra_antrag_felder` 
        ...
        (@bef_typ_id, 'dienstgrad', 'Aktueller Rank', 'text', 1, 2, 'half', 1, 'dienstgrad'),
    ...
    INSERT IGNORE INTO `intra_antrag_felder` 
        ...
        (@urlaub_typ_id, 'dienstgrad', 'Rank', 'text', 1, 2, 'half', NULL, 'dienstgrad'),
