...
class FahrtPolicy
{
    ...
    {
        return Permissions::check(['admin', 'fahrtenbuch.view']);
    }
    ...
    public static function update(?Fahrt $entry = null): bool
    {
        ...
        // (1) Admin
        if (isset($_SESSION['userid']) && Permissions::check(['admin', 'fahrtenbuch.manage'])) {
            return true;
        }
    ...
    {
        return isset($_SESSION['userid']) && Permissions::check(['admin', 'fahrtenbuch.manage']);
    }
}
