...
use App\Policies\AntragPolicy;
use PHPUnit\Framework\Attributes\Test;
use Tests\TestCase;

class AntragPolicyTest extends TestCase
{
    ...
    {
        $this->loginWith(['user']);
        $this->assertFalse(AntragPolicy::viewAny());

        $this->loginWith(['application.edit']);
        $this->assertTrue(AntragPolicy::viewAny());
    }
    ...
    public function view_returns_true_for_application_view_permission(): void
    {
        ...
        $this->assertTrue(AntragPolicy::view($a));
    }
    ...
    public function view_returns_false_for_other_users_antrag(): void
    {
        ...
        $this->assertFalse(AntragPolicy::view($a));
    }
    ...
    public function view_with_null_target_falls_back_to_global_permission(): void
    {
        ...
        $this->assertFalse(AntragPolicy::view(null));

        $this->loginWith(['application.view']);
        $this->assertTrue(AntragPolicy::view(null));
    }
    ...
    {
        $this->loginWith([]);
        $this->assertTrue(AntragPolicy::create());
    }

    #[Test]
    public function create_returns_false_when_not_logged_in(): void
    {
        $this->assertFalse(AntragPolicy::create());
    }
    ...
    {
        $this->loginWith(['application.view']);
        $this->assertFalse(AntragPolicy::decide());

        $this->loginWith(['application.edit']);
        $this->assertTrue(AntragPolicy::decide());
    }
}
