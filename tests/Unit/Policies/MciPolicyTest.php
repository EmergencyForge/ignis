 ...
 * verlangt aktuell `['admin', 'mci.manage']`. Tests fixieren das,
 ...
 * zu entkoppeln.
 */
class MciPolicyTest extends TestCase
{
    ...
    {
        $this->loginWith(['user']);
        $this->assertFalse(MciPolicy::$ability());
    }
    ...
    public function ability_passes_with_admin_permission(string $ability): void
    {
        ...
        $this->assertTrue(MciPolicy::$ability());
    }
    ...
    public function unrelated_permissions_dont_grant_access(): void
    {
        ...
        $this->assertFalse(MciPolicy::create());
        $this->assertFalse(MciPolicy::update());
        $this->assertFalse(MciPolicy::delete());
    }
}
