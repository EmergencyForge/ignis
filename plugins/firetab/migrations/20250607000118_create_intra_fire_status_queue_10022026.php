 ...
 *
 * Original-Datei: assets/database/create_intra_fire_status_queue_10022026.php
 * Spiegelung:     database/legacy/create_intra_fire_status_queue_10022026.php
 *
...
class CreateIntraFireStatusQueue10022026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_fire_status_queue_10022026.php';
    }
}
