 ...
 *
 * Original-Datei: assets/database/alter_intra_fire_incidents_20250125_allow_null.php
 * Spiegelung:     database/legacy/alter_intra_fire_incidents_20250125_allow_null.php
 *
...
class AlterIntraFireIncidents20250125AllowNull extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_fire_incidents_20250125_allow_null.php';
    }
}
