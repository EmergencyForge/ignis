 ...
 *
 * Original-Datei: assets/database/create_intra_manv_ressourcen_14122025.php
 * Spiegelung:     database/legacy/create_intra_manv_ressourcen_14122025.php
 *
...
class CreateIntraManvRessourcen14122025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_manv_ressourcen_14122025.php';
    }
}
