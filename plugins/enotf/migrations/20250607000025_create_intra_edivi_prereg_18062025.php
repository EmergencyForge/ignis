 ...
 *
 * Original-Datei: assets/database/create_intra_edivi_prereg_18062025.php
 * Spiegelung:     database/legacy/create_intra_edivi_prereg_18062025.php
 *
...
class CreateIntraEdiviPrereg18062025 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_edivi_prereg_18062025.php';
    }
}
