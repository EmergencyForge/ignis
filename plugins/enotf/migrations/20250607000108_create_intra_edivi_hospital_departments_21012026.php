 ...
 *
 * Original-Datei: assets/database/create_intra_edivi_hospital_departments_21012026.php
 * Spiegelung:     database/legacy/create_intra_edivi_hospital_departments_21012026.php
 *
...
class CreateIntraEdiviHospitalDepartments21012026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_edivi_hospital_departments_21012026.php';
    }
}
