 ...
 *
 * Original-Datei: assets/database/alter_intra_edivi_11022026_split_patname.php
 * Spiegelung:     database/legacy/alter_intra_edivi_11022026_split_patname.php
 *
...
class AlterIntraEdivi11022026SplitPatname extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_edivi_11022026_split_patname.php';
    }
}
