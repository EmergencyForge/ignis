 ...
 *
 * Original-Datei: assets/database/alter_intra_enotf_quicklinks_29122025_category_slug.php
 * Spiegelung:     database/legacy/alter_intra_enotf_quicklinks_29122025_category_slug.php
 *
...
class AlterIntraEnotfQuicklinks29122025CategorySlug extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_enotf_quicklinks_29122025_category_slug.php';
    }
}
