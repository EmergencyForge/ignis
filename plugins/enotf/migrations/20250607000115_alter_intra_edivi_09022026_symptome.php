 ...
 *
 * Original-Datei: assets/database/alter_intra_edivi_09022026_symptome.php
 * Spiegelung:     database/legacy/alter_intra_edivi_09022026_symptome.php
 *
...
class AlterIntraEdivi09022026Symptome extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_edivi_09022026_symptome.php';
    }
}
