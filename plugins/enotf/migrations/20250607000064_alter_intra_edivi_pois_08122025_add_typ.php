 ...
 *
 * Original-Datei: assets/database/alter_intra_edivi_pois_08122025_add_typ.php
 * Spiegelung:     database/legacy/alter_intra_edivi_pois_08122025_add_typ.php
 *
...
class AlterIntraEdiviPois08122025AddTyp extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_edivi_pois_08122025_add_typ.php';
    }
}
