 ...
 *
 * Original-Datei: assets/database/create_intra_kb_categories_tags_08032026.php
 * Spiegelung:     database/legacy/create_intra_kb_categories_tags_08032026.php
 *
...
class CreateIntraKbCategoriesTags08032026 extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/create_intra_kb_categories_tags_08032026.php';
    }
}
