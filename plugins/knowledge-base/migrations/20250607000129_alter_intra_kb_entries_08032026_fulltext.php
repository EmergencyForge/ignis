 ...
 *
 * Original-Datei: assets/database/alter_intra_kb_entries_08032026_fulltext.php
 * Spiegelung:     database/legacy/alter_intra_kb_entries_08032026_fulltext.php
 *
...
class AlterIntraKbEntries08032026Fulltext extends AbstractMigration
{
    public function change(): void
    {
        ...
        require __DIR__ . '/../legacy/alter_intra_kb_entries_08032026_fulltext.php';
    }
}
