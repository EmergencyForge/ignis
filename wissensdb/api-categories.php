<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/knowledgebase/categories.
...
$selfPath = 'wissensdb/api-categories.php';
...
header('Location: ' . rtrim($base, '/') . '/api/knowledgebase/categories' . $qs, true, 308);
exit;
