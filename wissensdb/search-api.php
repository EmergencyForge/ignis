<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/knowledgebase/search.
...
$selfPath = 'wissensdb/search-api.php';
...
header('Location: ' . rtrim($base, '/') . '/api/knowledgebase/search' . $qs, true, 308);
exit;
