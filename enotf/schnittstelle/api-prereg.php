<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/prereg.
...
$selfPath = 'enotf/schnittstelle/api-prereg.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/prereg' . $qs, true, 308);
exit;
