<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/check-conflict.
...
$selfPath = 'assets/functions/enotf/check_conflict.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/check-conflict' . $qs, true, 308);
exit;
