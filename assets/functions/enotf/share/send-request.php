<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/share/send-request.
...
$selfPath = 'assets/functions/enotf/share/send-request.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/share/send-request' . $qs, true, 308);
exit;
