<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/share/get-available-vehicles.
...
$selfPath = 'assets/functions/enotf/share/get-available-vehicles.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/share/get-available-vehicles' . $qs, true, 308);
exit;
