<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/share/accept-request.
...
$selfPath = 'assets/functions/enotf/share/accept-request.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/share/accept-request' . $qs, true, 308);
exit;
