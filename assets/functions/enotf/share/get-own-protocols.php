<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/share/get-own-protocols.
...
$selfPath = 'assets/functions/enotf/share/get-own-protocols.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/share/get-own-protocols' . $qs, true, 308);
exit;
