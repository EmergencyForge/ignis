<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/enotf/poi/save-field.
...
$selfPath = 'assets/functions/enotf/poi/save-field.php';
...
header('Location: ' . rtrim($base, '/') . '/api/enotf/poi/save-field' . $qs, true, 308);
exit;
