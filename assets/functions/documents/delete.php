<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/documents/delete.
...
$selfPath = 'assets/functions/documents/delete.php';
...
header('Location: ' . rtrim($base, '/') . '/api/documents/delete' . $qs, true, 308);
exit;
