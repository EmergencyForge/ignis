<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/documents/save.
...
$selfPath = 'assets/functions/documents/save.php';
...
header('Location: ' . rtrim($base, '/') . '/api/documents/save' . $qs, true, 308);
exit;
