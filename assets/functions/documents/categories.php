<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/documents/categories.
...
$selfPath = 'assets/functions/documents/categories.php';
...
header('Location: ' . rtrim($base, '/') . '/api/documents/categories' . $qs, true, 308);
exit;
