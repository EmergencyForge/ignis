<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/system/performance.
...
$selfPath = 'assets/functions/system/performance-api.php';
...
header('Location: ' . rtrim($base, '/') . '/api/system/performance' . $qs, true, 308);
exit;
