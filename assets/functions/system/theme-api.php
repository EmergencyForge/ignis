<?php
// Redirect-Stub — der Endpoint liegt seit dem Router-Cutover unter /api/system/theme.
...
$selfPath = 'assets/functions/system/theme-api.php';
...
header('Location: ' . rtrim($base, '/') . '/api/system/theme' . $qs, true, 308);
exit;
