...
>
    <header class="beladung-category-card__header">
        ...
        <div class="beladung-category-card__meta">
            ...
            <?php if ($canEdit): ?>
                <button type="button" class="ignis-ignis-btn ignis-btn--sm ignis-btn--soft-primary ignis-btn--icon edit-category-ignis-btn"
                ...
                <button type="button" class="ignis-ignis-btn ignis-btn--sm ignis-btn--outline-danger ignis-btn--icon delete-category-ignis-btn"
                        data-id="<?= (int) ($category['id'] ?? 0) ?>"
                    ...
                    <li class="beladung-tile" data-search="<?= htmlspecialchars($tileSearch) ?>"
                        ...
                        <span class="beladung-tile__amount">
                            <?php if ($canEdit): ?>
                                ...
                                <button type="button" class="ignis-ignis-btn ignis-btn--sm ignis-btn--ghost ignis-btn--icon edit-tile-ignis-btn"
                                ...
                                <button type="button" class="ignis-ignis-btn ignis-btn--sm ignis-btn--ghost-danger ignis-btn--icon delete-tile-ignis-btn"
                                        data-id="<?= (int) ($tile['id'] ?? 0) ?>"
