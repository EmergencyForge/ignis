...
<!-- Core-Bundle: jQuery + DataTables (synchron, wegen window.$-Nutzung in Inline-Scripts). DataTables braucht nur noch eNOTF; alle anderen Listen laufen über AppSupportistquery. -->
