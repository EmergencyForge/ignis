...
<div class="cirs-nav">
    <h6>Anträge</h6>
    <div class="cirs-link">
        <a href="<?= BASE_PATH ?>forms/befoerderung" class="no-underline">Neuen Beförderungsantrag stellen </i></a>
    </div>
    <?php
    if (isset($_SESSION['userid']) && isset($_SESSION['permissions'])) {
        if (Permissions::check(['admin', 'application.view'])) { ?>
            ...
            <div class="cirs-link mb-2">
                <a href="<?= BASE_PATH ?>forms/admin/list" class="no-underline">Übersicht</i></a>
            </div>
            <div class="cirs-link mb-2">
