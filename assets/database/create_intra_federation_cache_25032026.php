...
try {
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS `intra_federation_cache_personnel` (
            ...
            `dienstgrad_name` varchar(255) DEFAULT NULL,
            `dienstgrad_badge` varchar(255) DEFAULT NULL,
            `quali_rd` varchar(255) DEFAULT NULL,
            `quali_fw` varchar(255) DEFAULT NULL,
            `quali_fd` varchar(255) DEFAULT NULL,
