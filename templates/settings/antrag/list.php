                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="<?= BASE_PATH ?>settings/antrag/edit.php?id=<?= (int)$typ['id'] ?>" class="btn btn-soft-primary btn-icon mx-1" title="Bearbeiten">
                                                                <i class="fa-solid fa-edit"></i>
                                                            </a>
                                                            <a href="?toggle=<?= (int)$typ['id'] ?>" class="btn btn-soft-warning btn-icon mx-1" title="<?= $typ['aktiv'] ? 'Deaktivieren' : 'Aktivieren' ?>">
                                                                <i class="fa-solid fa-power-off"></i>
                                                            </a>
                                                            <?php if ((int)$typ['anzahl_antraege'] === 0): ?>
                                                                <a href="?delete=<?= (int)$typ['id'] ?>" class="btn btn-outline-danger mx-1" title="Löschen"
