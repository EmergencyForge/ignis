<?php
/**
 * View: enotf/protokoll/massnahmen/zugang/1_2_5.php
 *
 * @var \PDO $pdo
 */
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 flex flex-col edivi__interactbutton-more">
                            ...
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'massnahmen', 'zugang/1_2_5') ?>" class="active">
                                <span>anderer Ort</span>
                            </a>
                        </div>
                        <div class="col-1 flex flex-col edivi__interactbutton">
                            <?php
