<?php
/**
 * View: enotf/protokoll/erstbefund/neurologie/3_2.php
 *
 * @var \PDO $pdo
 */
            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'erstbefund', 'neurologie/3_1') ?>" data-requires="d_pupillenw_1,d_pupillenw_2">
                                <span>Pupillenweite</span>
                            </a>
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'erstbefund', 'neurologie/3_2') ?>" data-requires="d_lichtreakt_1,d_lichtreakt_2" class="active">
