                        ...
                        <div class="col-5">
                            ...
                            <div class="keypad-container">
                                ...
                                <div class="function-grid">
                                    ...
                                    <button type="button" class="keypad-ignis-btn special" onclick="keypadSetNG()">nicht gemessen</button>
                                    <button type="button" class="keypad-ignis-btn special" onclick="keypadSetNM()">nicht messbar</button>
                                </div>
                            </div>
                        </div>
                    </div>
