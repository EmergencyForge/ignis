<?php
/**
 * View: enotf/protokoll/erstbefund/kreislauf/3.php
 *
 * @var \PDO $pdo
 */
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'erstbefund', 'kreislauf/1') ?>" data-requires="c_kreislauf">
                                <span>Patientenzustand</span>
                            </a>
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'erstbefund', 'kreislauf/4') ?>">
                                <span>Rekap. Zeit</span>
                            </a>
                            <a href="<?= EnotfUrl::protokoll($daten['enr'], 'erstbefund', 'kreislauf/3') ?>" data-requires="c_puls_rad,c_puls_reg" class="active">
                                <span>Puls</span>
                            </a>
