                                ...
                                <div class="col">
                                    ...
                                    <div class="row my-2">
                                        <div class="col">
                                            ...
                                            ?>
                                                <select name="patsex" id="patsex" class="w-full form-select edivi__input-check" required data-custom-dropdown="true">
                                            ...
                                            ?>
                                                <select name="patsex" id="patsex" class="w-full form-select edivi__input-check" required autocomplete="off" data-custom-dropdown="true">
                                                    <option disabled hidden selected>---</option>
                                ...
                                <div class="col">
                                    <div class="row my-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="time" name="sende" id="sende" class="w-full form-control  text-center edivi__input-check" value="<?= !empty($zeiten['sende']) ? date('H:i', strtotime($zeiten['sende'])) : '' ?>" required>
                                            <input type="date" name="sende_datum" id="sende_datum" class="w-full form-control mt-1 text-center edivi__input-check" style="font-size:1rem;color:#a2a2a2;" value="<?= !empty($zeiten['sende']) ? date('Y-m-d', strtotime($zeiten['sende'])) : '' ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
